...
public class CustomExceptionHandler {
	...
	public Errors handleNotAllowed(HttpServletRequest req, HttpServletResponse res, ResourceNotFoundException e) {
		Errors errors = new Errors();
		errors.addError(new ErrorInfo(req.getRequestURL().toString(), HttpStatus.FORBIDDEN.toString(), e));
		return errors;
	}
	// }
}
